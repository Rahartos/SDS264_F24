...
state_data |>
  select(state, cig_tax12, abort_rank3) |>
  mutate(region = str_to_lower(str_squish(state))) |>
  left_join(us_states2, by = "region") |>
  filter( region == "southdakota")
